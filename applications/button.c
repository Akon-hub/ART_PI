...
{
    static Led_light_t led_light =
    {
            .led_switch = Red,
            .light_mode = "100,100",
            .loop_cnt = 2
    };
    rt_mb_send(&led_mail, (rt_uint32_t)&led_light);
...
int button_thread_init(void)
{
    ...
    button_board = agile_btn_create(GET_PIN(H, 4),PIN_LOW,PIN_MODE_INPUT_PULLDOWN);
...
INIT_APP_EXPORT(button_thread_init);
